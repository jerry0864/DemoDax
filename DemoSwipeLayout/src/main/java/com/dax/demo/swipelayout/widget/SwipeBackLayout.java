...
public class SwipeBackLayout extends FrameLayout {
    ...
    //private AutoScrollGrideView autoScrollGrideView;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.GMSwipeBackLayoutStyle);
    }
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int edgeSize = a.getDimensionPixelSize(R.styleable.SwipeBackLayout_game_edge_size, -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        setAllAreaCanScroll(false);
        int mode = EDGE_FLAGS[a.getInt(R.styleable.SwipeBackLayout_game_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        // int shadowLeft =
        // a.getResourceId(R.styleable.SwipeBackLayout_shadow_left,
        // R.drawable.shadow_left);
        // int shadowRight =
        // a.getResourceId(R.styleable.SwipeBackLayout_shadow_right,
        // R.drawable.shadow_right);
        // int shadowBottom =
        // a.getResourceId(R.styleable.SwipeBackLayout_shadow_bottom,
    ...
    /**
     * Set if all the area can scroll or not.
     * 
     */
    public void setAllAreaCanScroll(boolean isAllAreaCanScroll) {
        mDragHelper.setAllAreaCanScroll(isAllAreaCanScroll);
    }

    /**
     * Set the largest dragging angle.
     * 
     * @param pDragAngle Layout can be scrolled if dragging angle smaller than
     *            pDragAngle
     */
    public void setDragHorizontalAngle(double pDragAngle) {
        mDragHelper.setDragHorizontalAngle(pDragAngle);
    }
     ...
     *            pDragAngle
     */
    public void setDragVerticalAngle(double pDragAngle) {
        mDragHelper.setDragVerticalAngle(pDragAngle);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        // return false;
        // } else
//        if (autoScrollGrideView != null && isTouchOnChild(autoScrollGrideView, event)
//                && !autoScrollGrideView.isfirst()) {
//            return false;
//        }
...
//            if (child instanceof AutoScrollGrideView) {
//                autoScrollGrideView = (AutoScrollGrideView) child;
//            } else
            // if (child instanceof HorizontalListView) {
            // mChildListView = (HorizontalListView) child;
            // } else
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if ((mTrackingEdge & EDGE_LEFT) != 0) {
                ...
                left = xvel < 0 || xvel == 0 && mScrollPercent > mScrollThreshold ? -(childWidth + OVERSCROLL_DISTANCE)
                        : 0;
            } else if ((mTrackingEdge & EDGE_BOTTOM) != 0) {
                top = yvel < 0 || yvel == 0 && mScrollPercent > mScrollThreshold ? -(childHeight + OVERSCROLL_DISTANCE)
                        : 0;
            }
...
//    public void setAutoScrollGrideView(AutoScrollGrideView autoScrollGrideView) {
//        this.autoScrollGrideView = autoScrollGrideView;
//    }
