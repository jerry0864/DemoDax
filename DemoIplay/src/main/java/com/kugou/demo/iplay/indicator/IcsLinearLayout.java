...
class IcsLinearLayout extends LinearLayout {
    ...
    public void setDividerDrawable(Drawable divider) {
        ...
        if (divider != null) {
            ...
            Log.i("Indicator","height"+mDividerHeight);
        } else {
            mDividerWidth = 0;
            mDividerHeight = 0;
        }
...
//        Log.i(TAG,"left-----"+left);
//        Log.i(TAG,"top-----"+getPaddingTop() + mDividerPadding);
//        Log.i(TAG,"right-----"+left + mDividerWidth);
//        Log.i(TAG,"bottom-----"+(getHeight() - getPaddingBottom() - mDividerPadding));
        mDivider.draw(canvas);
    }
