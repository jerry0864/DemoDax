...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.game_vpiUnderlinePageIndicatorStyle);
    }
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        // final boolean defaultFades =
        // res.getBoolean(R.bool.default_underline_indicator_fades);
        // final int defaultFadeDelay =
        // res.getInteger(R.integer.default_underline_indicator_fade_delay);
        // final int defaultFadeLength =
        // res.getInteger(R.integer.default_underline_indicator_fade_length);
        ...
        setFades(a.getBoolean(R.styleable.UnderlinePageIndicator_game_fades, defaultFades));
        setSelectedColor(a.getColor(R.styleable.UnderlinePageIndicator_game_selectedColor,
                defaultSelectedColor));
        setFadeDelay(
                a.getInteger(R.styleable.UnderlinePageIndicator_game_fadeDelay, defaultFadeDelay));
        setFadeLength(a.getInteger(R.styleable.UnderlinePageIndicator_game_fadeLength,
                defaultFadeLength));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(left + pageWidth, top, right - pageWidth, bottom, mPaint);
    }
    ...
    // if (mIsDragging) {
    // mLastMotionX = x;
    // if (mViewPager.isFakeDragging() || mViewPager.()) {
